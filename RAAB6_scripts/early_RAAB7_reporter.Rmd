...
raab$clusterNumber<-raab$clusterId
raab$spectacles_used_distance<-raab$spectacles_used_distance=="true"
raab$spectacles_used_near<-raab$spectacles_used_near=="true"
...
```{r, eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-response-rate-a,echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-response-rate-b,echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-prev-dm-age-gender, echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-last-eye-exam,echo=FALSE,echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-prev-dr-in-diabetics, echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-grade-dr-in-diabetics, echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
...
```{r dr-diabetes-vi,echo=FALSE,eval=sum(!is.na(DR_check_early_r7$dr_diabetes_blood_consent)==TRUE)>0}
