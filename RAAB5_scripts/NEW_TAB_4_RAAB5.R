...
for (i in 1:length(re.vi.levels[1:3]))
{
...
newtab4$extrapolated.female.n<-format( newtab4$female.adj.pct * sum(female.subpop$population), digits = 0, big.mark = " ", big.interval= 3L, scientific = F)
