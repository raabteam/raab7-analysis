...
newtab6$total.n[newtab6$specs=="near"] <- sum(raab$spectacles_used_near==TRUE, na.rm = TRUE)
...
newtab6$total.n[newtab6$specs=="distance"] <- sum(raab$spectacles_used_distance==TRUE, na.rm = TRUE)
