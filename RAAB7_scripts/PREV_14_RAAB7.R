...
prev14$male.denom[prev14$denom.thresh=="612"]<-sum(raab$x_case_612[raab$gender=="male"],na.rm=T)+sum(raab$y_case_612[raab$gender=="male"],na.rm=T)+sum(raab$z_case_612[raab$gender=="male"],na.rm=T)
...
prev14$male.denom[prev14$denom.thresh=="660"]<-sum(raab$x_case_660[raab$gender=="male"],na.rm=T)+sum(raab$y_case_660[raab$gender=="male"],na.rm=T)+sum(raab$z_case_660[raab$gender=="male"],na.rm=T)
prev14$male.denom[prev14$denom.thresh=="360"]<-sum(raab$x_case_360[raab$gender=="male"],na.rm=T)+sum(raab$y_case_360[raab$gender=="male"],na.rm=T)+sum(raab$z_case_360[raab$gender=="male"],na.rm=T)

prev14$female.denom[prev14$denom.thresh=="612"]<-sum(raab$x_case_612[raab$gender=="female"],na.rm=T)+sum(raab$y_case_612[raab$gender=="female"],na.rm=T)+sum(raab$z_case_612[raab$gender=="female"],na.rm=T)
prev14$female.denom[prev14$denom.thresh=="618"]<-sum(raab$x_case_618[raab$gender=="female"],na.rm=T)+sum(raab$y_case_618[raab$gender=="female"],na.rm=T)+sum(raab$z_case_618[raab$gender=="female"],na.rm=T)
prev14$female.denom[prev14$denom.thresh=="660"]<-sum(raab$x_case_660[raab$gender=="female"],na.rm=T)+sum(raab$y_case_660[raab$gender=="female"],na.rm=T)+sum(raab$z_case_660[raab$gender=="female"],na.rm=T)
prev14$female.denom[prev14$denom.thresh=="360"]<-sum(raab$x_case_360[raab$gender=="female"],na.rm=T)+sum(raab$y_case_360[raab$gender=="female"],na.rm=T)+sum(raab$z_case_360[raab$gender=="female"],na.rm=T)

prev14$total.denom[prev14$denom.thresh=="612"]<-sum(raab$x_case_612,na.rm=T)+sum(raab$y_case_612,na.rm=T)+sum(raab$z_case_612,na.rm=T)
prev14$total.denom[prev14$denom.thresh=="618"]<-sum(raab$x_case_618,na.rm=T)+sum(raab$y_case_618,na.rm=T)+sum(raab$z_case_618,na.rm=T)
prev14$total.denom[prev14$denom.thresh=="660"]<-sum(raab$x_case_660,na.rm=T)+sum(raab$y_case_660,na.rm=T)+sum(raab$z_case_660,na.rm=T)
prev14$total.denom[prev14$denom.thresh=="360"]<-sum(raab$x_case_360,na.rm=T)+sum(raab$y_case_360,na.rm=T)+sum(raab$z_case_360,na.rm=T)

prev14$male.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<-sum(raab$x_case_612[raab$gender=="male"],na.rm=T)+sum(raab$y_case_612[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="618"]<-sum(raab$x_case_618[raab$gender=="male"],na.rm=T)+sum(raab$y_case_618[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="660"]<-sum(raab$x_case_660[raab$gender=="male"],na.rm=T)+sum(raab$y_case_660[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="360"]<-sum(raab$x_case_360[raab$gender=="male"],na.rm=T)+sum(raab$y_case_360[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<-sum(raab$a_case_612_612[raab$gender=="male"],na.rm=T)+sum(raab$b_case_612[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<-sum(raab$a_case_612_618[raab$gender=="male"],na.rm=T)+sum(raab$b_case_612[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<-sum(raab$a_case_612_660[raab$gender=="male"],na.rm=T)+sum(raab$b_case_612[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<-sum(raab$a_case_612_360[raab$gender=="male"],na.rm=T)+sum(raab$b_case_612[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<-sum(raab$a_case_618_612[raab$gender=="male"],na.rm=T)+sum(raab$b_case_618[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="618"]<-sum(raab$a_case_618_618[raab$gender=="male"],na.rm=T)+sum(raab$b_case_618[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="660"]<-sum(raab$a_case_618_660[raab$gender=="male"],na.rm=T)+sum(raab$b_case_618[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="360"]<-sum(raab$a_case_618_360[raab$gender=="male"],na.rm=T)+sum(raab$b_case_618[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<-sum(raab$a_case_660_612[raab$gender=="male"],na.rm=T)+sum(raab$b_case_660[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="618"]<-sum(raab$a_case_660_618[raab$gender=="male"],na.rm=T)+sum(raab$b_case_660[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="660"]<-sum(raab$a_case_660_660[raab$gender=="male"],na.rm=T)+sum(raab$b_case_660[raab$gender=="male"],na.rm=T)
prev14$male.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="360"]<-sum(raab$a_case_660_360[raab$gender=="male"],na.rm=T)+sum(raab$b_case_660[raab$gender=="male"],na.rm=T)
...
prev14$female.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="660"]<-sum(raab$x_case_660[raab$gender=="female"],na.rm=T)+sum(raab$y_case_660[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="360"]<-sum(raab$x_case_360[raab$gender=="female"],na.rm=T)+sum(raab$y_case_360[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<-sum(raab$a_case_612_612[raab$gender=="female"],na.rm=T)+sum(raab$b_case_612[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<-sum(raab$a_case_612_618[raab$gender=="female"],na.rm=T)+sum(raab$b_case_612[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<-sum(raab$a_case_612_660[raab$gender=="female"],na.rm=T)+sum(raab$b_case_612[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<-sum(raab$a_case_612_360[raab$gender=="female"],na.rm=T)+sum(raab$b_case_612[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<-sum(raab$a_case_618_612[raab$gender=="female"],na.rm=T)+sum(raab$b_case_618[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="618"]<-sum(raab$a_case_618_618[raab$gender=="female"],na.rm=T)+sum(raab$b_case_618[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="660"]<-sum(raab$a_case_618_660[raab$gender=="female"],na.rm=T)+sum(raab$b_case_618[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="360"]<-sum(raab$a_case_618_360[raab$gender=="female"],na.rm=T)+sum(raab$b_case_618[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<-sum(raab$a_case_660_612[raab$gender=="female"],na.rm=T)+sum(raab$b_case_660[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="618"]<-sum(raab$a_case_660_618[raab$gender=="female"],na.rm=T)+sum(raab$b_case_660[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="660"]<-sum(raab$a_case_660_660[raab$gender=="female"],na.rm=T)+sum(raab$b_case_660[raab$gender=="female"],na.rm=T)
prev14$female.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="360"]<-sum(raab$a_case_660_360[raab$gender=="female"],na.rm=T)+sum(raab$b_case_660[raab$gender=="female"],na.rm=T)
...
prev14$total.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="618"]<-sum(raab$x_case_618,na.rm=T)+sum(raab$y_case_618,na.rm=T)
prev14$total.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="660"]<-sum(raab$x_case_660,na.rm=T)+sum(raab$y_case_660,na.rm=T)
prev14$total.num[prev14$num.thresh=="csc" & prev14$denom.thresh=="360"]<-sum(raab$x_case_360,na.rm=T)+sum(raab$y_case_360,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<-sum(raab$a_case_612_612,na.rm=T)+sum(raab$b_case_612,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<-sum(raab$a_case_612_618,na.rm=T)+sum(raab$b_case_612,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<-sum(raab$a_case_612_660,na.rm=T)+sum(raab$b_case_612,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<-sum(raab$a_case_612_360,na.rm=T)+sum(raab$b_case_612,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<-sum(raab$a_case_618_612,na.rm=T)+sum(raab$b_case_618,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="618"]<-sum(raab$a_case_618_618,na.rm=T)+sum(raab$b_case_618,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="660"]<-sum(raab$a_case_618_660,na.rm=T)+sum(raab$b_case_618,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="360"]<-sum(raab$a_case_618_360,na.rm=T)+sum(raab$b_case_618,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<-sum(raab$a_case_660_612,na.rm=T)+sum(raab$b_case_660,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="618"]<-sum(raab$a_case_660_618,na.rm=T)+sum(raab$b_case_660,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="660"]<-sum(raab$a_case_660_660,na.rm=T)+sum(raab$b_case_660,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="360"]<-sum(raab$a_case_660_360,na.rm=T)+sum(raab$b_case_660,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<-sum(raab$a_case_360_612,na.rm=T)+sum(raab$b_case_360,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="618"]<-sum(raab$a_case_360_618,na.rm=T)+sum(raab$b_case_360,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="660"]<-sum(raab$a_case_360_660,na.rm=T)+sum(raab$b_case_360,na.rm=T)
prev14$total.num[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="360"]<-sum(raab$a_case_360_360,na.rm=T)+sum(raab$b_case_360,na.rm=T)
...
prev14$male.adjusted.lci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons[raab$gender=="male"],raab$denom.618.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons[raab$gender=="male"],raab$denom.660.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons[raab$gender=="male"],raab$denom.360.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.lci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$male.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.uci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons[raab$gender=="male"],raab$denom.618.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons[raab$gender=="male"],raab$denom.660.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons[raab$gender=="male"],raab$denom.360.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$male.adjusted.uci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$male.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons[raab$gender=="male"],raab$denom.612.persons[raab$gender=="male"],raab$clusterNumber[raab$gender=="male"])
...
prev14$female.adjusted.lci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons[raab$gender=="female"],raab$denom.618.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons[raab$gender=="female"],raab$denom.660.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons[raab$gender=="female"],raab$denom.360.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.lci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$female.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.uci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons[raab$gender=="female"],raab$denom.618.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons[raab$gender=="female"],raab$denom.660.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons[raab$gender=="female"],raab$denom.360.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$female.adjusted.uci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$female.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons[raab$gender=="female"],raab$denom.612.persons[raab$gender=="female"],raab$clusterNumber[raab$gender=="female"])
...
prev14$total.adjusted.lci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons,raab$denom.618.persons,raab$clusterNumber)
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons,raab$denom.660.persons,raab$clusterNumber)
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons,raab$denom.360.persons,raab$clusterNumber)
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.lci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.lci(prev14$total.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.uci[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="csc" & prev14$denom.thresh=="612"],raab$csc.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="612"],raab$ecsc.612.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="618"],raab$ecsc.612.618.num.persons,raab$denom.618.persons,raab$clusterNumber)
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="660"],raab$ecsc.612.660.num.persons,raab$denom.660.persons,raab$clusterNumber)
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_612" & prev14$denom.thresh=="360"],raab$ecsc.612.360.num.persons,raab$denom.360.persons,raab$clusterNumber)
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_618" & prev14$denom.thresh=="612"],raab$ecsc.618.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_660" & prev14$denom.thresh=="612"],raab$ecsc.660.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
...
prev14$total.adjusted.uci[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"]<- bennett.uci(prev14$total.adjusted[prev14$num.thresh=="ecsc_360" & prev14$denom.thresh=="612"],raab$ecsc.360.612.num.persons,raab$denom.612.persons,raab$clusterNumber)
