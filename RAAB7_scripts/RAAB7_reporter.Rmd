...
meta_dataset<-data.frame(
  ...
  subject="Eye Diseases; Vision Disorders; Cataract; Cataract Extraction; Refractive errors; Health Services Research; Health Surveys",
  subjectVocab="mesh",
  description="Anonymous participant level dataset including variables for visual acuity, spectacle use, lens status, cause of vision impairment, cataract surgical history, barriers to cataract surgery",
  publisher="London School of Hygiene & Tropical Medicine RAAB Repository",
  contributor=NA,
  date=format(Sys.time(), '%Y-%m-%d'),
  type="Dataset",
...
write.table(sum1.nice.names, here("outputs", ID, "summary", "data", "eligible_persons_coverage_absentees_and_refusals.csv"),row.names=F,col.names=T,sep=",")

names(sum1.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(sum1.nice.names, booktabs=T, linesep = "", caption = "Eligible persons, coverage, absentees and refusals", align='lcccccc') %>%
...
write.table(asa1.nice.names,here("outputs", ID, "summary", "data", "age_and_gender_distribution_of_people_examined_in_the_sample.csv"),row.names=F,col.names=T,sep=",")

names(asa1.nice.names)<-c("Years","n","%","n","%","n","%")

knitr::kable(asa1.nice.names, booktabs=T, linesep = "", caption = "Age and gender distribution of people examined in the sample", align='lcccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(4,hline_after=T) %>%
...
write.table(asa2.nice.names,here("outputs", ID, "summary", "data", "total_number_of_people_aged_50plus_in_survey_area.csv"),row.names=F,col.names=T,sep=",")

names(asa2.nice.names)<-c("Years","n","%","n","%","n","%")

knitr::kable(asa2.nice.names, booktabs=T, linesep = "", caption = "Total number of people aged 50+ in survey area", align='lcccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(4,hline_after=T) %>%
  add_header_above(c("Age group" = 1, "Female" = 2, "Male" = 2, "Total" = 2),bold=T)
...
write.table(sum3a.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_blindness_severe_moderate_and_mild_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(sum3a.nice.names)<-c("","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(sum3a.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of blindness, severe, moderate and mild vision impairment", align='lccccccccc') %>%
  kable_styling(full_width=T,latex_options="HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(sum3b.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_and_extrapolated_magnitude_of_blindness_severe_moderate_and_mild_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(sum3b.nice.names)<-c("","%","95% CI","Extraplotated magnitude","%","95% CI","Extrapolated magnitude","%","95% CI","Extrapolated magnitude")

knitr::kable(sum3b.nice.names, booktabs=T, linesep = "", caption = "Adjusted prevalence and extrapolated magnitude of blindness, severe, moderate and mild vision impairment", align='lccccccccc') %>%
...
These tables show the crude and adjusted prevalence of vision impairment by impairment level and gender. The sample size for RAAB is calculated to provide an acceptable level of precision for the total prevalence of blindness. The accuracy of prevalence estimates for population subgroups is lower and caution should be taken in the interpretation of these data. Table P2 shows the estimated magnitude of vision impairment in the study area by gender, calculated by multiplying the crude prevalence by the population count (e.g., census data). Throughout, the 95% confidence intervals are calculated to account for RAAB's cluster sampling design.
...
write.table(asa6a.nice.names,here("outputs", ID, "summary", "data", "crude_cumulative_prevalence_of_blindness_severe_moderate_and_mild_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(asa6a.nice.names)<-c("","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(asa6a.nice.names, booktabs=T, linesep = "", caption = "Crude cumulative prevalence of blindness (any PVA <3/60), severe (any PVA <6/60), moderate (any PVA <6/18) and mild (any PVA <6/12) vision impairment", align='lccccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(asa6b.nice.names,here("outputs", ID, "summary", "data", "adjusted_cumulative_prevalence_of_blindness_severe_moderate_and_mild_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(asa6b.nice.names)<-c("","%","95% CI","Extrapolated magnitude","%","95% CI","Extrapolated magnitude","%","95% CI","Extrapolated magnitude")

knitr::kable(asa6b.nice.names, booktabs=T, linesep = "", caption = "Adjusted cumulative prevalence of blindness (any PVA <3/60), severe (any PVA <6/60), moderate (any PVA <6/18) and mild (any PVA <6/12) vision impairment",align='lccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(c(4,7,10),width='2cm') %>%
  add_header_above(c("VI level" = 1, "Female" = 3, "Male" = 3, "Total" = 3),bold = T)
...
write.table(unta.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_blind_severe_moderate_and_mild_unilateral_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(unta.nice.names) <- c(' ', 'n', '%', '95% CI', 'n', '%', '95% CI', 'n', '%', '95% CI')

knitr::kable(unta.nice.names,booktabs=T, linesep = "",caption="Crude prevalence of blind, severe, moderate and mild unilateral vision impairment",align='lccccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(untb.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_and_extrapolated_magnitude_of_blind_severe_moderate_and_mild_unilateral_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(untb.nice.names) <- c("", "%","95% CI","Extrapolated magnitude","%","95% CI","Extrapolated magnitude","%","95% CI","Extrapolated magnitude")

knitr::kable(untb.nice.names, booktabs=T, linesep = "", caption="Adjusted prevalence and extrapolated magnitude of blind, severe, moderate and mild unilateral vision impairment",align='lccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(c(4,7,10),width='2cm') %>%
  add_header_above(c("VI level" = 1, "Female" = 3, "Male" = 3, "Total" = 3),bold=T) %>%
...
write.table(crude.near.re.prev.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_near_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

names(crude.near.re.prev.nice.names) <- c(' ', 'n', '%', '95% CI', 'n', '%', '95% CI', 'n', '%', '95% CI')

knitr::kable(crude.near.re.prev.nice.names,booktabs=T, linesep = "",caption="Crude prevalence of near vision impairment",align='lccccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='3.5cm') %>%
  column_spec(c(4,7,10),width='1.5cm') %>%
...
write.table(adj.near.re.prev.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_of_near_vision_impairment.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(adj.near.re.prev.nice.names,booktabs=T, linesep = "",caption="Adjusted prevalence of near vision impairment",align='lccccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(sum6.nice.names,here("outputs", ID, "summary", "data", "principal_cause_of_blindness_severe_moderate_and_mild_vision_impairment.csv"),row.names=F,col.names=T,sep=",")

sum6.for.tree<-sum6.numeric

names(sum6.nice.names) <- c(' ', 'n', '%', 'n', '%','n', '%','n', '%')

knitr::kable(sum6.nice.names, booktabs=T, linesep = "", caption = "Principal cause of blindness, severe, moderate and mild vision impairment",align='lcccccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(sum6ag,here("outputs", ID, "summary", "data", "principal_cause_of_blindness_severe_moderate_and_mild_vision_impairment_by_intervention_category.csv"),row.names=F,col.names=T,sep=",")

names(sum6ag)<-c("","n", "%", "n", "%", "n","%","n","%")

knitr::kable(sum6ag, booktabs=T, linesep = c('', '', '', '\\addlinespace'), caption = "Principal cause of blindness, severe, moderate and mild vision impairment, by intervention category",align='lcccccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(prev4.nice.names,here("outputs", ID, "summary", "data", "principal_cause_of_blindness_in_males_and_females.csv"),row.names=F,col.names=T,sep=",")

names(prev4.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(prev4.nice.names, booktabs=T, linesep = "", caption = "Principal cause of blindness in males and females",align='lcccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(15,hline_after=T) %>%
  column_spec(1,width='6cm') %>%
...
write.table(prev4ag,here("outputs", ID, "summary", "data", "principal_cause_of_blindness_by_gender_and_intervention_category.csv"),row.names=F,col.names=T,sep=",")

names(prev4ag)<-c("","n", "%", "n", "%", "n","%")

knitr::kable(prev4ag, booktabs=T, linesep = c('', '', '', '\\addlinespace'), caption = "Principal cause of blindness (PVA <3/60), by gender and intervention category",align='lcccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='5cm') %>%
...
write.table(catops.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_people_bilaterally_and_unilaterally_cataract_operated.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(catops.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of people bilaterally and unilaterally cataract operated",align='lcccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='3cm') %>%
...
write.table(catcovdenom.a.nice.names,here("outputs", ID, "summary", "data", "crude_unmet_need_for_cataract_surgery_at_different_pinhole_VA_thresholds.csv"),row.names=F,col.names=T,sep=",")

names(catcovdenom.a.nice.names)<-c(" ","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(catcovdenom.a.nice.names, booktabs=T, linesep = "", caption = "Crude unmet need for cataract surgery at pinhole VA thresholds <3/60, <6/60, <6/18 and <6/12",align='lcccccc') %>%
  kable_styling(latex_options = c("scale_down", "HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(catcovdenom.b.nice.names,here("outputs", ID, "summary", "data", "extrapolated_magnitude_of_unmet_need_for_cataract_surgery_at_different_pinhole_VA_thresholds.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(catcovdenom.b.nice.names, booktabs=T, linesep = "", caption = "Extrapolated magnitude of unmet need for cataract surgery at pinhole VA thresholds <3/60, <6/60, <6/18 and <6/12",align='lccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(c(4,7,10),width='2cm') %>%
  add_header_above(c("Unmet need threshold" = 1, "Female" = 3, "Male" = 3, "Total" = 3),bold=T)
...
write.table(asa7a.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_cataract_at_different_surgical_thresholds.csv"),row.names=F,col.names=T,sep=",")

names(asa7a.nice.names)<-c(" ","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(asa7a.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of cataract at surgical thresholds <3/60, <6/60, <6/18 and <6/12",align='lcccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(asa7b.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_and_extrapolated_magnitude_of_cataract_at_different_surgical_thresholds.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(asa7b.nice.names, booktabs=T, linesep = "", caption = "Adjusted prevalence and extrapolated magnitude of cataract at surgical thresholds <3/60, <6/60, <6/18 and <6/12",align='lccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(c(4,7,10),width='2cm') %>%
  pack_rows("Bilateral",1,4) %>%
...
write.table(prev14a.nice.names,here("outputs", ID, "summary", "data", "adjusted_cataract_surgical_coverage_and_effective_cataract_surgical_coverage_at_the_person_level.csv"),row.names=F,col.names=T,sep=",")

names(prev14a.nice.names)<-c("","Adj. %","95% CI","Adj. %","95% CI","Adj. %","95% CI","%")

knitr::kable(prev14a.nice.names, booktabs=T, linesep = "", caption = "Adjusted cataract surgical coverage and effective cataract surgical coverage at the person level",row.names=F,align='lccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(sum11.nice.names,here("outputs", ID, "summary", "data", "barriers_to_cataract_surgery_among_participants_with_bilateral_cataract_and_pinva_lessthan660.csv"),row.names=F,col.names=T,sep=",")

names(sum11.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(sum11.nice.names,booktabs=T, linesep = "", caption="Barriers to cataract surgery among participants with bilateral cataract and PinVA <6/60",align='lcccccc') %>%
  kable_styling(full_width=T,latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(newtab2.nice.names,here("outputs", ID, "summary", "data", "type_of_cataract_surgery_performed_count_by_eyes.csv"),row.names=F,col.names=T,sep=",")

names(newtab2.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(newtab2.nice.names, booktabs=T, linesep = "", caption = "Type of cataract surgery performed, count by eyes",align='lcccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(4,hline_after=T) %>%
...
write.table(newtab3a.nice.names,here("outputs", ID, "summary", "data", "post-operative_visual_outcome_presenting_va_count_by_eyes.csv"),row.names=F,col.names=T,sep=",")

names(newtab3a.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(newtab3a.nice.names, booktabs=T, linesep = "", caption = "Post-operative visual outcome (PVA), count by eyes",align='lcccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(newtab3b.nice.names,here("outputs", ID, "summary", "data", "post-operative_visual_outcome_pinhole_va_count_by_eyes.csv"),row.names=F,col.names=T,sep=",")

names(newtab3b.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(newtab3b.nice.names, booktabs=T, linesep = "", caption = "Post-operative visual outcome (PinVA), count by eyes",align='lcccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(3,hline_after=T) %>%
  column_spec(1,width='4cm') %>%
...
write.table(outc6a.nice.names,here("outputs", ID, "summary", "data", "post-operative_visual_outcomes_presenting_va_in_eyes_by_place_of_surgery_male.csv"),row.names=F,col.names=T,sep=",")

names(outc6a.nice.names)<-c("","n","%","n","%","n","%","n","%","n","%")

knitr::kable(outc6a.nice.names, booktabs=T, linesep = "", caption = "Post-operative visual outcomes (PVA) in eyes by place of surgery (male)",align='lcccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(3,hline_after=T) %>%
...
write.table(outc6b.nice.names,here("outputs", ID, "summary", "data", "post-operative_visual_outcomes_presenting_va_in_eyes_by_place_of_surgery_female.csv"),row.names=F,col.names=T,sep=",")

names(outc6b.nice.names)<-c("","n","%","n","%","n","%","n","%","n","%")

knitr::kable(outc6b.nice.names, booktabs=T, linesep = "", caption = "Post-operative visual outcomes (PVA) in eyes by place of surgery (female)",align='lcccccccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(3,hline_after=T) %>%
  add_header_above(c("Post-surgical VA" = 1, "Gov. Hosp." = 2, "Vol. Hosp." = 2, "Priv. Hosp." = 2, "Camp Improv." = 2, "Trad." = 2),bold=T)
...
write.table(dist.re.prev.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_distance_refractive_error_by_age_group_and_gender.csv"),row.names=F,col.names=T,sep=",")

names(dist.re.prev.nice.names)<-c("Years","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(dist.re.prev.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of distance refractive error by age group and gender",align='lccccccccc') %>%
...
write.table(newtab6.nice.names,here("outputs", ID, "summary", "data", "distance_and_near_vision_spectacle_use_among_study_participants.csv"),row.names=F,col.names=T,sep=",")

names(newtab6.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(newtab6.nice.names, booktabs=T, linesep = "", caption = "Distance and near vision spectacle use among study participants",align='lcccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(newtab5.nice.names,here("outputs", ID, "summary", "data", "adjusted_distance_refractive_error_coverage_and_effective_refractive_error_coverage.csv"),row.names=F,col.names=T,sep=",")

names(newtab5.nice.names) <- c(" ","Adj. %", "95% CI","Adj. %", "95% CI","Adj. %", "95% CI", "%")

knitr::kable(newtab5.nice.names, booktabs=T, linesep = "", caption = "Adjusted distance effective refractive error coverage and refractive error coverage", row.names=F,align = 'lccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,'2cm') %>%
...
write.table(dist.re.need.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_of_need_for_distance_refractive_error_correction_by_gender.csv"),row.names=F,col.names=T,sep=",")

names(dist.re.need.nice.names) <- c(" ","Adj. %", "95% CI","Extrap. magnitude","Adj. %", "95% CI","Extrap. magnitude","Adj. %", "95% CI","Extrap. magnitude")

knitr::kable(dist.re.need.nice.names, booktabs=T, linesep = "", caption = "Adjusted prevalence of met need, undermet need, unmet need and no need for distance refractive error correction by gender", row.names=F,align = 'lcccccc') %>%
  kable_styling(full_width=T, latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,'2cm') %>%
...
write.table(newtab7.nice.names,here("outputs", ID, "summary", "data", "adjusted_near_refractive_error_coverage_and_effective_refractive_error_coverage.csv"),row.names=F,col.names=T,sep=",")

names(newtab7.nice.names) <- c(" ","Adj. %", "95% CI","Adj. %", "95% CI","Adj. %", "95% CI", "%")

knitr::kable(newtab7.nice.names, booktabs=T, linesep = "", caption = "Adjusted near refractive error coverage and effective refractive error coverage", row.names=F,align = 'lccccccc') %>%
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,'2cm') %>%
  column_spec(c(3,5,7),'1.5cm') %>%
...
write.table(near.re.need.nice.names,here("outputs", ID, "summary", "data", "adjusted_prevalence_of_need_for_near_refractive_error_correction_by_gender.csv"),row.names=F,col.names=T,sep=",")

names(near.re.need.nice.names) <- c(" ","Adj. %", "95% CI","Extrap. magnitude","Adj. %", "95% CI","Extrap. magnitude","Adj. %", "95% CI","Extrap. magnitude")

knitr::kable(near.re.need.nice.names, booktabs=T, linesep = "", caption = "Adjusted prevalence of met need, undermet need, unmet need and no need for near refractive error correction by gender", row.names=F,align = 'lcccccc') %>%
  kable_styling(full_width=T, latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,'3cm') %>%
  column_spec(c(3,6,9),'1.5cm') %>%
...
write.table(dr.response.a.nice.names,here("outputs", ID, "summary", "data", "raab_survey_and_dr_module_response_rate.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(dr.response.a.nice.names, booktabs=T, linesep = "", caption = "RAAB survey and DR module response rate",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='5cm') %>%
  add_header_above(c("Exam status" = 1, "Female" = 2, "Male" = 2, "Total" = 2),bold=T) %>%
...
write.table(dr.response.b.nice.names,here("outputs", ID, "summary", "data", "known_or_suspected_diabetes_among_participants_assessed_for_diabetes_status.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(dr.response.b.nice.names, booktabs=T, linesep = "", caption = "Known or suspected diabetes among participants assessed for diabetes status",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='5cm') %>%
...
write.table(dm.prev.final.nice.names,here("outputs", ID, "summary", "data", "prevalence_of_known_or_suspected_diabetes_among_participants_assessed_for_diabetes_status_by_age_and_gender.csv"),row.names=F,col.names=T,sep=",")

names(dm.prev.final.nice.names)<-c("Years","n","%","95% CI","n","%","95% CI","n","%","95% CI")

knitr::kable(dm.prev.final.nice.names, booktabs=T, linesep = "", caption = "Prevalence of known or suspected diabetes among participants assessed for diabetes status, by age group and gender",align='lccccccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position", font_size = 8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(4,hline_after=T) %>%
  add_header_above(c("Age group" = 1, "Female" = 3, "Male" = 3, "Total" = 3),bold=T)
...
write.table(dr.last.exam.table.nice.names,here("outputs", ID, "summary", "data", "self-reported_time_since_last_eye_examination_for_diabetic_retinopathy_among_known_diabetics.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(dr.last.exam.table.nice.names, booktabs=T, linesep = "", caption = "Self-reported time since last eye examination for diabetic retinopathy among known diabetics",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  row_spec(4,hline_after=T) %>%
  column_spec(1,width='5cm') %>%
...
write.table(any.dr.mac.laser.prev.nice.names,here("outputs", ID, "summary", "data", "prevalence_of_retinopathy_and_maculopathy_among_known_and_suspect_diabetics_in_the_sample.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(any.dr.mac.laser.prev.nice.names, booktabs=T, linesep = "", caption = "Prevalence of retinopathy and maculopathy among (known and suspect) diabetics in the sample",align='lccccccccc') %>% 
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  add_header_above(c(" " = 1, "Female" = 3, "Male" = 3, "Total" = 3),bold=T) 
...
write.table(ret.mac.prev.nice.names,here("outputs", ID, "summary", "data", "grade_of_retinopathy_and_maculopathy_among_known_and_suspect_diabetics_in_the_sample.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(ret.mac.prev.nice.names, booktabs=T, linesep = "", caption = "Grade of retinopathy and maculopathy among (known and suspect) diabetics in the sample",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='4cm') %>%
...
write.table(dm.vi.table.nice.names,here("outputs", ID, "summary", "data", "prevalence_of_vision_impairment_among_known_and_suspected_diabetics_and_non-diabetics.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(dm.vi.table.nice.names, booktabs=T, linesep = "", caption = "Prevalence of vision impairment among known and suspected diabetics and non-diabetics",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='4cm') %>%
...
Any participant reporting “a lot” or greater difficulty in any domain is considered to have a disability. The seeing domain will capture many people with vision impairment identified through VA screening, but also people with other types of vision loss such as contrast sensitivity, stereoacuity or visual fields . It can also provide information on how people with reduced VA perceive their vision loss.
...
```{r wgq-dis-prev,echo=FALSE, eval=sum(!is.na(WQ_check$wg_difficulty_seeing)==TRUE) + sum(!is.na(WQ_check$wg_difficulty_hearing)==TRUE) + sum(!is.na(WQ_check$wg_difficulty_memory)==TRUE) + sum(!is.na(WQ_check$wg_difficulty_mobility)==TRUE) + sum(!is.na(WQ_check$wg_difficulty_selfcare)==TRUE) >0}

source(here("RAAB7_scripts","wgq-dis-prev.R"))

wgq.domains.table.nice.names<-wgq.domains.table

write.table(wgq.domains.table.nice.names,here("outputs", ID, "summary", "data", "crude_prevalence_of_self-reported_disability_by_functional_domain.csv"),row.names=F,col.names=T,sep=",")

names(wgq.domains.table.nice.names)<-c("","n","%","n","%","n","%")

knitr::kable(wgq.domains.table.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of self-reported disability by functional domain",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='5cm') %>%
...
write.table(wgq.vi.table.a,here("outputs", ID, "summary", "data", "crude_prevalence_of_vision_impairment_by_disability_status.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(wgq.vi.table.a, booktabs=T, linesep = "", caption = "Crude prevalence of vision impairment by disability status",align='lccccccccc') %>% 
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(wgq.vi.table.b,here("outputs", ID, "summary", "data", "adjusted_prevalence_of_vision_impairment_by_disability_status.csv"),row.names=F,col.names=T,sep=",")
...
knitr::kable(wgq.vi.table.b, booktabs=T, linesep = "", caption = "Adjusted prevalence of vision impairment by disability status",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
write.table(wgq.ecsc.nice.names,here("outputs", ID, "summary", "data", "adjusted_effective_cataract_surgical_coverage_by_disability_status.csv"),row.names=F,col.names=T,sep=",")

names(wgq.ecsc.nice.names)<-c("","Adj. %","95% CI","Adj. %","95% CI","Adj. %","95% CI")

knitr::kable(wgq.ecsc.nice.names, booktabs=T, linesep = "", caption = "Adjusted effective cataract surgical coverage by disability status",row.names=F,align='lcccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='4cm') %>%
