...
treemap(near.re.need,index="need",vSize="total.extrapolated.n",type="index",palette = need_fig_cols, position.legend="right", fontsize.title = 8, title="The need for near refractive error correction in the population 50 years and older with distance pinhole VA 6/12 or better")
