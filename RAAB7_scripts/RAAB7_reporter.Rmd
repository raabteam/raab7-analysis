...
write.table(cat.oc.time.nice.names,here("outputs", ID, "summary", "data", "cat13.csv"),row.names=F,col.names=T,sep=",")
...
write.table(causes.po.va.nice.names,here("outputs", ID, "summary", "data", "cat14.csv"),row.names=F,col.names=T,sep=",")
...
write.table(specs.near.owns.table,here("outputs", ID, "summary", "data", "re9.csv"),row.names=F,col.names=T,sep=",")
...
write.table(specs.near.none.table,here("outputs", ID, "summary", "data", "re10.csv"),row.names=F,col.names=T,sep=",")
...
wgq.erec.dist.nice.names$any.dis.adj.pct.ci        <- paste0(wgq.erec.dist.nice.names$any.dis.adj.pct.lci, " - ", wgq.erec.dist.nice.names$any.dis.adj.pct.uci)
wgq.erec.dist.nice.names$any.non.vi.dis.adj.pct.ci <- paste0(wgq.erec.dist.nice.names$any.non.vi.dis.adj.pct.lci, " - ", wgq.erec.dist.nice.names$any.non.vi.dis.adj.pct.uci)
wgq.erec.dist.nice.names$no.dis.adj.pct.ci         <- paste0(wgq.erec.dist.nice.names$no.dis.adj.pct.lci, " - ", wgq.erec.dist.nice.names$no.dis.adj.pct.uci)
...
write.table(wgq.erec.dist.nice.names,here("outputs", ID, "summary", "data", "wgq5.csv"),row.names=F,col.names=T,sep=",")
...
wgq.erec.near.nice.names$any.dis.adj.pct.ci        <- paste0(wgq.erec.near.nice.names$any.dis.adj.pct.lci, " - ", wgq.erec.near.nice.names$any.dis.adj.pct.uci)
wgq.erec.near.nice.names$any.non.vi.dis.adj.pct.ci <- paste0(wgq.erec.near.nice.names$any.non.vi.dis.adj.pct.lci, " - ", wgq.erec.near.nice.names$any.non.vi.dis.adj.pct.uci)
wgq.erec.near.nice.names$no.dis.adj.pct.ci         <- paste0(wgq.erec.near.nice.names$no.dis.adj.pct.lci, " - ", wgq.erec.near.nice.names$no.dis.adj.pct.uci)
...
write.table(wgq.erec.near.nice.names,here("outputs", ID, "summary", "data", "wgq6.csv"),row.names=F,col.names=T,sep=",")
