...
## History of near spectacle ownership and barriers to near spectacles")
...
knitr::kable(specs.near.owns.table, booktabs=TRUE, caption="Near spectacle history among all study participants who own near spectacles (RE9)") %>%
  kable_styling(latex_options="HOLD_position", font_size=8) %>%
  row_spec(0, italic=TRUE) %>%
  add_indent(c(2,3, 5:7, 9:10, 12:14, 16:17, 19:20)) %>% 
  column_spec(1, width="5cm") %>%
  add_header_above(c(" " = 1, "Female" = 2, "Male" = 2, "Total" = 2), bold=TRUE) %>%
  add_footnote("Near spectacle owners may have met need, undermet need, or no need but own near spectacles",notation = "symbol")
...
knitr::kable(specs.near.none.table, booktabs=TRUE, caption="Barriers to near spectacle history among study participants with unmet need for near spectacles (RE10)") %>%
  kable_styling(latex_options="HOLD_position", font_size=8) %>%
  row_spec(0, italic=TRUE) %>%
