...
Case selection implies pre-existing co-morbidity and no improvement in VA with surgery. Refractive error accounts for residual refractive error defined by improvement to 6/12 with pinhole.  
