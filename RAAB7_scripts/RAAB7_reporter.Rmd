...
```{r, eval=raab_meta$data_access=="data_access_results_reports_data", echo=FALSE}
...
asis_output("Available at:  ") 

```

```{r, eval=raab_meta$data_access=="data_access_results_reports_data", echo=FALSE}

asis_output(paste0("https://www.doi.org/",meta_report$doi))
...
knitr::kable(asa7a.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of cataract at surgical thresholds <3/60, <6/60, <6/18 and <6/12 (CAT4)",align='lcccccc') %>%
  kable_styling(latex_options = c("scale_down","HOLD_position"),font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
...
knitr::kable(wgq.domains.table.nice.names, booktabs=T, linesep = "", caption = "Crude prevalence of self-reported disability by functional domain (WGQ1)",align='lcccccc') %>% 
  kable_styling(full_width=T, latex_options = "HOLD_position",font_size=8) %>%
  row_spec(0,italic=TRUE) %>%
  column_spec(1,width='5cm') %>%
...
points(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$upperbodystrength.pct,pch=20,col=wgq_fig_cols[6])
lines(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$upperbodystrength.pct,col=wgq_fig_cols[6])
points(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$upperbodydexterity.pct,pch=20,col=wgq_fig_cols[6])
lines(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$upperbodydexterity.pct,col=wgq_fig_cols[6])
points(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$anxiety.pct,pch=20,col=wgq_fig_cols[6])
lines(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$anxiety.pct,col=wgq_fig_cols[6])
points(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$depression.pct,pch=20,col=wgq_fig_cols[6])
lines(as.numeric(as.factor(wgq.plot$age.groups.tens)),wgq.plot$depression.pct,col=wgq_fig_cols[6])
