...
newtab4$extrapolated.female.n<-format( newtab4$female.adj.pct * sum(female.subpop$population), digits = 1, scientific=F)
newtab4$extrapolated.male.n<-format( newtab4$male.adj.pct * sum(male.subpop$population), digits = 1, scientific=F)
newtab4$extrapolated.total.n<-format( newtab4$total.adj.pct * sum(popfives$population), digits = 1, scientific=F)
