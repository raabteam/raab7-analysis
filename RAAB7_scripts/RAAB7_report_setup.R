...
#Operated definition 2: Excluded couched eyes from aphakia definition
  right_operated = case_when(((raab$lens_status_right=="lens_status_absent" & raab$surgery_type_right!="surgery_type_couching") | raab$lens_status_right=="lens_status_pseudophakia_no_pco" | raab$lens_status_right=="lens_status_pseudophakia_with_pco") ~ 1, TRUE ~ 0),
  left_operated = case_when(((raab$lens_status_left=="lens_status_absent" & raab$surgery_type_left!="surgery_type_couching") | raab$lens_status_left=="lens_status_pseudophakia_no_pco" | raab$lens_status_left=="lens_status_pseudophakia_with_pco") ~ 1, TRUE ~ 0)
...
#eCSC and CSC denominator definition 2: Any cause of VI in non-operated eyes (with addition of !=operated to define non-operated eye)
    ...
    z_case_612 = case_when((raab$right_distance_acuity_pinhole>0.3 & left_distance_acuity_pinhole>0.3) & (raab$right_operated!=1 & raab$left_operated!=1) & (raab$right_operable_612==1 | raab$left_operable_612==1) ~ 1, TRUE ~ 0),
    
    y_case_618 = case_when((raab$right_operated==1 & raab$left_operated==1) ~ 1, TRUE ~ 0),
    z_case_618 = case_when((raab$right_distance_acuity_pinhole>0.47 & left_distance_acuity_pinhole>0.47) & (raab$right_operated!=1 & raab$left_operated!=1) & (raab$right_operable_618==1 | raab$left_operable_618==1) ~ 1, TRUE ~ 0),
    
    y_case_660 = case_when((raab$right_operated==1 & raab$left_operated==1) ~ 1, TRUE ~ 0),
    z_case_660 = case_when((raab$right_distance_acuity_pinhole>1 & left_distance_acuity_pinhole>1) & (raab$right_operated!=1 & raab$left_operated!=1) & (raab$right_operable_660==1 | raab$left_operable_660==1) ~ 1, TRUE ~ 0),
    
    y_case_360 = case_when((raab$right_operated==1 & raab$left_operated==1) ~ 1, TRUE ~ 0),
    z_case_360 = case_when((raab$right_distance_acuity_pinhole>1.3 & left_distance_acuity_pinhole>1.3) & (raab$right_operated!=1 & raab$left_operated!=1) & (raab$right_operable_360==1 | raab$left_operable_360==1) ~ 1, TRUE ~ 0),
